...
namespace SportAcademy.Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260919212843_AddPushSubscriptions")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.CoachBranchAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CoachId", "BranchId")
                        .IsUnique();

                    b.ToTable("CoachBranchAccesses", (string)null);
                });
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.Finance.DiscountCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.Finance.Expense", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.Finance.ExpenseCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.Finance.SubscriptionDiscountRequest", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CreatedSubscriptionDetailsId");
                    ...
                    b.ToTable("SubscriptionDiscountRequests", (string)null);
                });
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.Marketing.Lead", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<int?>("TraineeCountBand")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.NotificationDelivery", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("ResolvedDestination")
                        .HasMaxLength(320)
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.NotificationEventType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.PushSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.SportPrice", b =>
                {
                    ...
                    b.HasKey("SportId", "BranchId", "SubsTypeId", "GroupType");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.SubscriptionDetails", b =>
                {
                    ...
                    b.HasIndex("SportId", "BranchId", "SubscriptionTypeId", "GroupType");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.TenantNotificationChannelRule", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TenantId", "EventTypeId", "Channel")
                        .IsUnique()
                        .HasDatabaseName("IX_TenantNotificationChannelRule_Tenant_EventType_Channel");

                    b.ToTable("TenantNotificationChannelRules", (string)null);
                });
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.Tenants.Tenant", b =>
                {
                    ...
                    b.Property<DateTime?>("FirstDashboardLoadAt")
                        .HasColumnType("datetime2");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.Translations.FamilyTranslation", b =>
                {
                    b.Property<int>("FamilyId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("FamilyId", "LangCode");

                    b.HasIndex("TenantId");

                    b.ToTable("FamilyTranslations", (string)null);
                });
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.UserBranchAccess", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.UserNotificationPreference", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.Finance.Expense", b =>
                {
                    ...
                    b.HasOne("SportAcademy.Domain.Entities.Finance.ExpenseCategory", "ExpenseCategory")
                        .WithMany("Expenses")
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.Finance.InvoiceLine", b =>
                {
                    b.HasOne("SportAcademy.Domain.Entities.Finance.DiscountCode", "DiscountCode")
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.Finance.SubscriptionDiscountRequest", b =>
                {
                    ...
                    b.HasOne("SportAcademy.Domain.Entities.SubscriptionDetails", "CreatedSubscriptionDetails")
                        .WithMany()
                        .HasForeignKey("CreatedSubscriptionDetailsId")
                        .OnDelete(DeleteBehavior.Restrict);
                    ...
                    b.Navigation("CreatedSubscriptionDetails");
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.SubscriptionDetails", b =>
                {
                    ...
                    b.HasOne("SportAcademy.Domain.Entities.SportPrice", "SportPrice")
                        ...
                        .HasForeignKey("SportId", "BranchId", "SubscriptionTypeId", "GroupType")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("SportAcademy.Domain.Entities.TenantNotificationChannelRule", b =>
                {
                    b.HasOne("SportAcademy.Domain.Entities.NotificationEventType", "EventType")
                        .WithMany()
