...
namespace SportAcademy.Application.Interfaces
{
    public interface IUserRepository : IBaseRepository<AppUser, Guid>
    {
        ...
        /// Ids of every current-tenant user with a linked Employee record (coaches, accountants,
        /// managers, admins - any role holding an Employee record counts). Backs the
        /// "Employees" notification group.
        Task<List<Guid>> GetEmployeeUserIdsAsync(CancellationToken ct = default);
    }
}
