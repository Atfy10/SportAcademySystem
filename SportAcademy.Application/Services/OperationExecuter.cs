...
namespace SportAcademy.Application.Services
{
    public class OperationExecutor
    {
        ...
        public async Task<Result> Execute<T>(Func<Task<Result>> operation, OperationType opType)
        {
            Result res;
            try
            {
            ...
            catch (ArgumentOutOfRangeException ex)
            {
                ...
                return Result.Failure(opType.ToString(), ex.Message, 400);
            }
            ...
            catch (NullReferenceException ex)
            {
                ...
                return Result.Failure(opType.ToString(), ex.Message, 500);
            }
            ...
            catch (KeyNotFoundException ex)
            {
                ...
                return Result.Failure(opType.ToString(), ex.Message, 404);
            }
            ...
            catch (EmailExistException ex)
            {
                ...
                return Result.Failure(opType.ToString(), ex.Message, 409);
            }
            ...
            catch (UnauthorizedAccessException ex)
            {
                ...
                return Result.Failure(opType.ToString(), "Unauthorized access: " + ex.Message, 401);
            }
            catch (Exception ex)
            {
                _logger.LogError(ex, "Unexpected error occurred during {Operation}", opType);
                return Result.Failure(opType.ToString(), "An unexpected error occurred. Please try again later.", 500);
            }
